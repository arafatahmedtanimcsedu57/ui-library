...
export interface PickerToggleProps<T = DataItemValue>
...
> = React.forwardRef((props: PickerToggleProps, ref) => {
  ...
  const inputValue = useMemo(() => {
    if (
      typeof inputValueProp === "number" ||
      typeof inputValueProp === "string"
    ) {
  ...
  const handleClean = useEventCallback(
  ...
  return (
    <Component
      ...
      aria-activedescendant={
        active && focusItemValue ? `${id}-opt-${focusItemValue}` : undefined
      }
      {...rest}
