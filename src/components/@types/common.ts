...
export interface PickerBaseProps<L = unknown> extends WithAsProps, AnimationEventProps {
  id?: string;
...
export type ToArray<V> = V extends unknown[] ? V : V[];
...
export interface FormControlPickerProps<T = unknown, L = unknown, D = Record<string, unknown>, I = T>
...
export interface ItemDataType<T = number | string> extends Record<string, unknown> {
