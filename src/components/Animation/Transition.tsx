...
export interface TransitionProps extends AnimationEventProps {
  ...
  /** Primary content */
  children?:
    | ((props: unknown, ref: React.Ref<unknown>) => React.ReactNode)
    | React.ReactNode;
...
class Transition extends React.Component<TransitionProps, TransitionState> {
  ...
  childRef: React.RefObject<unknown>;
  ...
  render() {
    ...
    const childProps: unknown = omit(rest, Object.keys(transitionPropTypes));
    ...
    const child = React.Children.only(
      children,
    ) as React.DetailedReactHTMLElement<unknown, HTMLElement>;
